...
const GENERAL_EVENT_ATTENDANCES = '/events/date/stats'
...
module.exports = {
    ...
    ATTENDANCES_STATS_URL, EVENT_CALENDAR_SCHEDULE_URL, EVENT_STATUS_STATS_URL, GENERAL_EVENT_ATTENDANCES
    ,REPORTS_STATS_URL, TOP_ORGANIZERS_URL,
    ATTENDANCES_TOTAL_STATS_URL, HISTORIC_STATS_URL
};

...
module.exports = {
    ...
    ATTENDANCES_STATS_URL, EVENT_CALENDAR_SCHEDULE_URL, EVENT_STATUS_STATS_URL,
    EVENTS_DATES_STATS_URL, REPORTS_STATS_URL, TOP_ORGANIZERS_URL,
    ATTENDANCES_TOTAL_STATS_URL, HISTORIC_STATS_URL, TOP_REPORTED_ORGANIZRS_URL,
    ALL_STATS_URL
};

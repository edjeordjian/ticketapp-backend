...
const UNAUTHORIZED_EVENT_ERR_LBL = "No tiene permisos para ver información del evento";
...
const WRONG_DATE_FORMAT_ERR_LBL = "Error en el formato de las fechas indicadas";
...
module.exports = {
    ...
    EVENT_WAS_MODIFIED, SUSPENDED_EVENT_LBL, UNSUSPENDED_EVENT_LBL, UNAUTHORIZED_EVENT_ERR_LBL,
    WRONG_DATE_FORMAT_ERR_LBL
};
